...
public class ChineseCharUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isChinese("“测试”，。？！%……&*（）——{}【】”"));
        System.out.println(isChinese("Ã©Å¸Â©Ã©Â¡ÂºÃ¥Â¹Â³"));
        System.out.println(isChinese("专109"));
        System.out.println(isChinese("840鐠猴拷"));
        System.out.println(isChinese("840"));
    }
     ...
     */
    public static boolean isChineseCharacter_f2() {
        String str = "！？";
